...
/// Extends HiveConnectorSplit to leverage existing Hive file reading
/// infrastructure.
struct HiveDeltaSplit : public connector::hive::HiveConnectorSplit {
  ...
  /// @param infoColumns Additional metadata columns (e.g., file path,
  /// modification time)
  /// @param fileProperties Optional file properties (row count, file size,
  /// etc.)
  HiveDeltaSplit(
